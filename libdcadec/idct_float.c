...
static void sum_a(const double * input, double * output, int len)
{
    for (int i = 0; i < len; i++)
        output[i] = input[2 * i] + input[2 * i + 1];
}

static void sum_b(const double * input, double * output, int len)
{
    output[0] = input[0];
    for (int i = 1; i < len; i++)
        output[i] = input[2 * i] + input[2 * i - 1];
...
static void sum_c(const double * input, double * output, int len)
{
    for (int i = 0; i < len; i++)
        output[i] = input[2 * i];
}

static void sum_d(const double * input, double * output, int len)
{
    output[0] = input[1];
    for (int i = 1; i < len; i++)
...
static void dct_a(const struct idct_context * idct,
...
static void dct_b(const struct idct_context * idct,
                  const double * input, double * output)
{
    for (int i = 0; i < 8; i++) {
        double res = input[0];
...
static void mod_a(const struct idct_context * idct,
                  const double * input, double * output)
{
    for (int i = 0; i < 8; i++)
...
static void mod_b(const struct idct_context * idct,
...
static void mod_c(const struct idct_context * idct,
                  const double * input, double * output)
{
    for (int i = 0; i < 16; i++)
...
static void mod64_a(const struct idct_context * idct,
                    const double * input, double * output)
{
    for (int i = 0; i < 16; i++)
...
static void mod64_b(const struct idct_context * idct,
                    double * input, double * output)
{
    for (int i = 0; i < 16; i++)
...
static void mod64_c(const struct idct_context * idct,
                    const double * input, double * output)
{
    for (int i = 0; i < 32; i++)

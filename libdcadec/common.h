...
#endif
#ifdef _MSC_VER
#include "dcadec_msvc.h"
#define dca_bswap16(x) DCA_SWAP16(x)
#define dca_bswap32(x) DCA_SWAP32(x)
#define dca_bswap64(x) DCA_SWAP64(x)
#define dca_clz32(x) msvc_clz(x)
#define dca_clz64(x) msvc_clz64(x)
...
#undef DCA_MIN
#include <Windows.h>
#define DCA_MAX(a,b) max(a,b)
#define DCA_MIN(a,b) min(a,b)
#endif
...
#ifdef _MSC_VER
#undef DCA_MEM32NE
static __inline unsigned __DCA_MEM32NE(void* data)
{
	unsigned res;
	memcpy(&res,data,sizeof(res));
	return res;
}
#define DCA_MEM32NE(data) __DCA_MEM32NE(data)
#endif
